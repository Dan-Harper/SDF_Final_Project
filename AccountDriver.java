...
public class AccountDriver {
    ...
    public static void doDeposit(Account accounts [], int count, Scanner keyboard) {
        ...
        if(index >= 0) {
            // Amount
            System.out.print("Pleae enter Deposit Amount: ");
    ...
    public static void doWithdraw(Account accounts [], int count, Scanner keyboard) {
        ...
        if(index >= 0) {
            // Amount
            System.out.print("Pleae enter Withdraw Amount: ");
            double amount = keyboard.nextDouble();
    ...
    public static Account createAccount(Scanner keyboard) {
        ...
        if(choice == 1) { // checking account
            ...
            System.out.print("Pleae enter Interest Rate: ");
    ...
    /*
    * Menu to display optiuons and get the user's selection
    *
    * @param keyboard
    * @return choice
    */
